...
- Optional: lightly polish existing Tier 1 posts for better line economy without flattening the voice: `npm --prefix services/api/functions run posts:tier1-rewrite -- --model gpt-5-mini`
