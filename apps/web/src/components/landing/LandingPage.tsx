...
export default function LandingPage() {
  ...
  const [isDarkMode, setIsDarkMode] = useTabState("orecce:web:page:landing:theme:v1", false);
  const [authMode, setAuthMode] = useTabState<AuthMode>("orecce:web:page:landing:auth-mode:v1", "login");
  const [name, setName] = useTabState("orecce:web:page:landing:name:v1", "");
  const [email, setEmail] = useTabState("orecce:web:page:landing:email:v1", "");
