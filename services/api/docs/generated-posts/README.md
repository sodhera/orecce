...
- To tighten existing Tier 1 posts for compact carousel formatting with `gpt-5-mini`: `npm --prefix services/api/functions run posts:tier1-rewrite -- --model gpt-5-mini`
