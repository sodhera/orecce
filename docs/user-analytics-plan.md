...
- Web feed, Recce discovery, and collection views now resume from a tab-scoped cache after focus-triggered remounts without introducing new analytics event names.
